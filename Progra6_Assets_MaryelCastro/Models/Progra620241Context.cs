...
namespace Progra6_Assets_MaryelCastro.Models;
...
public partial class Progra620241Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AssetId).HasName("PK__Asset__43492372E2FF15A4");
        ...
        {
            entity.HasKey(e => e.AssetCategoryId).HasName("PK__AssetCat__C381F49D871241BF");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCDA2CD8DC5");
        ...
        {
            entity.HasKey(e => e.DepreciationId).HasName("PK__Deprecia__DEEBFE29F80510A0");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC0D87FFFF");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A55D55D5B53");
